...
EXPORT_FUNC(PyInitConfig_AddModule)
EXPORT_FUNC(PyInitConfig_Create)
EXPORT_FUNC(PyInitConfig_Free)
EXPORT_FUNC(PyInitConfig_FreeStrList)
EXPORT_FUNC(PyInitConfig_GetError)
EXPORT_FUNC(PyInitConfig_GetExitCode)
EXPORT_FUNC(PyInitConfig_GetInt)
EXPORT_FUNC(PyInitConfig_GetStr)
EXPORT_FUNC(PyInitConfig_GetStrList)
EXPORT_FUNC(PyInitConfig_HasOption)
